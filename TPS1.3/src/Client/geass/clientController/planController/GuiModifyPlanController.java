...
public class GuiModifyPlanController {
  ...
  /**
	...
	*/
	...
	/**
	 * 用于读取表格内容
	 * 将一个HH:mm形式的字符串转换成util.Date类型的时间
	 * @param timestr
	 * @param datestr
	 ...
	 * @param oldStartdate
	 * @param newStartdate
	 * @param isDeleteConfirmed 
	 * true:确认要删除新日期之前的计划内容 
	 * false：尚未确认删除新日期之前的计划内容 
	 * @return 设置结果
	 * 返回2，表示没有更改
	 * 返回1，表示该新开始日期在原来开始日期之前；或已确认删除，成功修改
	 ...
	 * @param newEnddate
	 * @param isDeleteConfirmed 
	 * true:确认要删除新日期之后的计划内容 
	 * false：尚未确认删除新日期之后的计划内容 
	 * @return 设置结果
	 * 返回2，表示没有更改
	 * 返回1，表示该新结束日期在原来结束日期之后
